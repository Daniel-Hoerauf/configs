...
plugins=(git archlinux jsontools pip python sudo virtualenvwrapper)
...
# Automatically rehash added or removed commands
...
alias l='ls -AGSF1sh --color --group-directories-first'
...
# opam configuration
test -r /home/doc/.opam/opam-init/init.zsh && . /home/doc/.opam/opam-init/init.zsh > /dev/null 2> /dev/null || true
